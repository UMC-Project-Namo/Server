...
import static com.namo.spring.application.external.api.notification.dto.FcmNotificationRequest.toAndroidFcmMessageDto;
import static com.namo.spring.application.external.api.notification.dto.FcmNotificationRequest.toIosFcmMessageDto;
...
public class FcmJsonMessageBuilder {
    ...
    public String buildIOSFcmMessage(String token, String title, String body, Map<String, String> data, int badge) throws JsonProcessingException {
