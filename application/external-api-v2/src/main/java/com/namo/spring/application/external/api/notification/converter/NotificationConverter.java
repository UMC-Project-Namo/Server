...
public class NotificationConverter {
    public static Notification toScheduleReminderNotification(String message, Device device, Schedule schedule,
            LocalDateTime notifyTime) throws JsonProcessingException {
        return Notification.of(PublisherType.SYSTEM, null, device, schedule, notifyTime,
                NotificationType.SCHEDULE_REMINDER, message);
    }

    public static Notification toScheduleUpdateNotification(String message, NotificationType type, Schedule schedule,
    ...
    public static Notification toFriendshipNotification(String message, NotificationType type, Member publisher,
            Device device) {
