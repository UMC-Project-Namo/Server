...
public class AuthController {
	...
	public ResponseDto<MemberResponse.SignUpDto> kakaoSignup(
	...
	@PreAuthorize("isAnonymous()")
	public ResponseDto<MemberResponse.SignUpDto> naverSignup(
		@Valid @RequestBody MemberRequest.SocialSignUpDto signUpDto
	) {
		return null;
	}
	...
	public ResponseDto<MemberResponse.ReissueDto> reissueAccessToken(
		@Valid @RequestBody MemberRequest.SignUpDto signUpDto
	) {
		return null;
	}
	...
	public ResponseDto<Void> logout(
		@Valid @RequestBody MemberRequest.LogoutDto logoutDto
	) {
		return null;
	}
