...
public class GroupFacade {
    ...
    public List<GroupResponse.GetGroupDto> getGroups(Long userId) {
        User user = userService.getUser(userId);
        ...
        return GroupResponseConverter.toGetGroupDtos(groupAndUsersInGroups, curUsersGroupAndUsers);
    }
    ...
    public GroupResponse.GroupParticipantDto createGroupAndUser(Long userId, String code) {
        ...
        groupAndUserService.createGroupAndUser(groupAndUser, group);
        return GroupResponseConverter.toGetGroupParticipantDto(group);
    }
