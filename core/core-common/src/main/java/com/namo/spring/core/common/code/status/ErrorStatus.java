...
public enum ErrorStatus implements BaseErrorCode {
    ...
    NOT_FOUND_MEETING_SCHEDULE_FAILURE(HttpStatus.NOT_FOUND, "모임 스케줄을 찾을 수 없습니다."),
    ...
    NOT_FOUND_GROUP_USER_FAILURE(HttpStatus.NOT_FOUND, "그룹 구성원이 아닙니다."),
    NOT_FOUND_MEETING_SCHEDULE_AND_USER_FAILURE(HttpStatus.NOT_FOUND, "모임 스케줄 구성원이 아닙니다."),
